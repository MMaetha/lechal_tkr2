...
export default class Graph extends Component {
  ...
  componentDidMount() {
    var DateEiei = ["Day 1", "Day 2", "Day 3", "Day 4", "Day 5", "Day 6", "Day 7", "Day 8", "Day 9", "Day 10",
    ...
    if (myChart) {
      for (var index = 0; index < DateEiei.length; ++index) {
        myChart.data.datasets[0].data.push(1000);
        myChart.data.labels.push(DateEiei[index]);
        myChart.data.datasets[0].backgroundColor.push('rgba(145, 168, 208, 1)');
      }
